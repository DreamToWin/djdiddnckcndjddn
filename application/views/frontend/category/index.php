    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <h3 class="panel-title">
                ...
                <?php echo isset($title) ? $title : 'Chuyên mục'; ?>
            </h3>
        </div>
        <div class="panel-body">
            <div class="row">
                ...
                if (count($categories) > 0) :
                    ...
                    ?>
                <p class="text-center"><img alt="Đang tải" src="<?php echo site_url('publics/frontend/img/ajax-loader.gif'); ?>"> <strong>Đợi xíu nữa nhé. Sắp ra rồi! :P</strong></p>
                <?php endif; ?>
            </div>
